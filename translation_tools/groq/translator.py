...
#"yo" - йоруба (Нигерия) llama c ним как-то очень плохо работает удалил 
...
class GroqTranslator:
    def __init__(self):
        self.client = Groq(api_key="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")
        self.buffer_text = []
    ...
    def split_into_chunks(self, array, chunk_size=7):
